...
class SMCAnalyzer:
    ...
    # ============================================================
    #  STRICT HIGH-QUALITY SIGNAL GENERATOR (~60% target)
    # ============================================================
    def generate_signal(self):
        ...
        # ---- Volatility guard: skip dead markets ----
        ...
        # ---- Refuse to fight higher timeframe trend ----
        ...
        # 2. Fresh structure break in last 20 bars (+20)
        ...
        # 3. Unmitigated OB near price (+20)
        ...
        # 4. Unfilled FVG in bias direction (+15)
